...
fname_pihat = fullfile('/space/amdale/1/tmp/ABCD_cache/abcd-sync/3.0/genomics/ABCD_rel3.0_pihat.mat'); %FIXME: replace with 4.0 when available

%To run multiple deisgn matrices with same imaging data populate each row with path to each design matrix
designmat_dir = '/space/syn50/1/data/ABCD/d9smith/random_effects/imaging/nda4.0/offrel/designmat';
...
outpath = '/space/syn50/1/data/ABCD/d9smith/random_effects/analysis/imaging/nda4.0';
