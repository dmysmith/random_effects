...
outpath = '/space/ceph/1/ABCD/users/d9smith/random_effects/results_mom_100perms_2024-05-01';
...
fname_design = '/space/ceph/1/ABCD/users/d9smith/random_effects/designMat/designMat02_t1w_AgeSexScanSoft.txt';
...
nperms = 100; % Number of permutations - if wanting to use resampling methods nperms>0
...
RandomEstType = 'MoM'; % 'ML'; % specify random effects estimator (default is MoM)
Hessflag=1;
logLikflag=0;
ciflag=0;
      ...
      if doVertexwiseSmri
          ...
          switch dataRelease
                ...
                case '4.0'
                      ...
                      fstems = {'area_ic5_sm1000' 'sulc_ic5_sm1000' 'thickness_ic5_sm1000'};
          ...
          for m=1:length(fstems)
                ...
                save(fpaths_out{:}, 'Hessmat', '-append');
                save(fpaths_out{:}, 'sig2mat_perm', '-append');
          end
